...
if __name__ == "__main__":
    ...
    pcds = [];
    trajectory = read_pinhole_camera_trajectory("../../../../data/RGBD/trajectory.log")
    write_pinhole_camera_trajectory("test.json", trajectory)
    print(trajectory)
    print(trajectory.extrinsic)
    print(np.asarray(trajectory.extrinsic))
    for i in range(5):
        im1 = read_image("../../../../data/RGBD/depth/{:05d}.png".format(i))
        im2 = read_image("../../../../data/RGBD/color/{:05d}.jpg".format(i))
