...
if __name__ == "__main__":
    ...
    pcd0 = read_point_cloud("../../../../data/Feature/cloud_bin_0.pcd")
    pcd1 = read_point_cloud("../../../../data/Feature/cloud_bin_1.pcd")
    ...
    feature0 = read_feature("../../../../data/Feature/cloud_bin_0.fpfh.bin")
    feature1 = read_feature("../../../../data/Feature/cloud_bin_1.fpfh.bin")
    ...
    print("Black : matching distance > 0.2")
    print("White : matching distance = 0")
    feature0 = read_feature("../../../../data/Feature/cloud_bin_0.d32.bin")
    feature1 = read_feature("../../../../data/Feature/cloud_bin_1.d32.bin")
    fpfh_tree = KDTreeFlann(feature1)
    for i in range(len(pcd0.points)):
        [_, idx, _] = fpfh_tree.search_knn_vector_xd(feature0.data[:, i], 1)
        dis = np.linalg.norm(pcd0.points[i] - pcd1.points[idx[0]])
